        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                ...
                <ul class="navbar-nav mx-auto">
                    <li class="nav-item">
                        <a class="nav-link fw-semibold mx-2 <?php echo $current == '../public/index.php' ? 'active' : ''; ?>"
                            href="../public/index.php">Home</a>
                    </li>
                    <li class="nav-item dropdown">
                        <a class="nav-link fw-semibold mx-2 dropdown-toggle <?php echo in_array($current, ['../public/shop.php', '../public/perawatan.php', '../public/penitipan.php', '../public/konsultasi.php']) ? 'active' : ''; ?>"
                            href="#" role="button" data-bs-toggle="dropdown">
                            Layanan
                        </a>
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../public/shopawal.php">Shop</a></li>
                            <li><a class="dropdown-item" href="../public/perawatan.php">Perawatan</a></li>
                            <li><a class="dropdown-item" href="../public/penitipan.php">Penitipan</a></li>
                            <li><a class="dropdown-item" href="../public/konsultasi.php">Konsultasi</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-semibold mx-2 <?php echo $current == '../public/shopawal.php' ? 'active' : ''; ?>"
                            href="../public/shopawal.php">Shop</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link fw-semibold mx-2 <?php echo $current == '../public/aboutawal.php' ? 'active' : ''; ?>"
                            href="../public/aboutawal.php">About Us</a>
                    </li>
                </ul>
