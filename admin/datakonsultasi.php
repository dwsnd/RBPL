...
// Get konsultasi data with related information
$query = "SELECT k.*, 
          p.nomor_pesanan,
          p.tanggal_pesanan,
          p.status_pembayaran,
...
<head>
    ...
    <title>Data Konsultasi | Ling-Ling Pet Shop</title>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link active" href="datakonsultasi.php">
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="header-actions">
                <a href="tambah.php?type=konsultasi" class="btn btn-primary">
        ...
        <div class="content-card">
            <div class="table-responsive">
                <table id="konsultasiTable" class="table table-striped">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>No. Pesanan</th>
                        ...
                        while ($row = $result->fetch_assoc()):
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="hapus.php?type=konsultasi&id=<?php echo $row['id_konsultasi']; ?>"
