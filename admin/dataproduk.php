...
<head>
    ...
    <title>Data Produk | Ling-Ling Pet Shop</title>
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-nav">
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link text-danger me-3" href="logout.php">
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="header-actions">
                <a href="tambah.php?type=produk" class="btn btn-primary">
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ($row['foto_utama']): ?>
                                        <img src="../<?php echo $row['foto_utama']; ?>" alt="<?php echo $row['nama_produk']; ?>"
                                ...
                                <td>
                                    ...
                                    <?php if ($row['sub_kategori']): ?>
                                        <br><small class="text-muted"><?php echo $row['sub_kategori']; ?></small>
                                    <?php endif; ?>
                                </td>
                                <td><?php echo ucfirst($row['kategori']); ?></td>
                                <td>
                                    <?php
                                    $target_hewan = explode(',', $row['target_hewan']);
                                    foreach ($target_hewan as $hewan) {
                                        echo '<span class="badge bg-info me-1">' . ucfirst($hewan) . '</span>';
                                    }
                                    ?>
                                </td>
                                ...
                                <td>
                                    ...
                                    echo match ($row['status']) {
                                        'aktif' => ($row['stok'] > 0 ? 'success' : 'warning'),
                                        'nonaktif' => 'secondary',
                                        'habis' => 'danger',
                                        default => 'secondary'
                                    };
                                ...
                                <td>
                                    <a href="ubah.php?type=produk&id=<?php echo $row['id_produk']; ?>"
                                        class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="hapus.php?type=produk&id=<?php echo $row['id_produk']; ?>"
