...
// Get pesanan data with related information
$query = "SELECT p.*, 
          pl.nama_lengkap as nama_pelanggan,
          pl.email as email_pelanggan,
          pl.nomor_telepon as telepon_pelanggan,
          CASE 
              WHEN p.jenis_pesanan = 'produk' THEN (
                  SELECT GROUP_CONCAT(CONCAT(pp.quantity, 'x ', pr.nama_produk) SEPARATOR ', ')
              ...
              WHEN p.jenis_pesanan = 'penitipan' THEN (
                  ...
                  WHERE pl.id_pesanan = p.id_pesanan
              )
              WHEN p.jenis_pesanan = 'konsultasi' THEN (
                  SELECT CONCAT('Konsultasi dengan ', dh.nama_dokter)
                  FROM konsultasi k
                  JOIN dokter_hewan dh ON k.id_dokter = dh.id_dokter
                  WHERE k.id_pesanan = p.id_pesanan
              )
              WHEN p.jenis_pesanan = 'perawatan' THEN (
                  SELECT CONCAT('Perawatan ', pr.paket_perawatan, ' untuk ', a.nama_hewan)
                  FROM perawatan pr
                  JOIN anabul a ON pr.id_anabul = a.id_anabul
                  JOIN pesanan_layanan pl ON pr.id_pesanan_layanan = pl.id_detail
                  WHERE pl.id_pesanan = p.id_pesanan
              )
          END as detail_pesanan
          FROM pesanan p
...
<head>
    ...
    <title>Data Pesanan | Ling-Ling Pet Shop</title>
    ...
    <div class="main-content">
        <div class="header">
            ...
            <div class="header-actions">
                <a href="tambah.php?type=pesanan" class="btn btn-primary">
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_assoc()):
                            ...
                            <tr>
                                ...
                                <td><?php echo ucfirst($row['jenis_pesanan']); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="ubah.php?type=pesanan&id=<?php echo $row['id_pesanan']; ?>"
                                        class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    <a href="hapus.php?type=pesanan&id=<?php echo $row['id_pesanan']; ?>"
